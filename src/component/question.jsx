...
const Questioner =()=>{
    const questionList = [
              ...
              },
              {
                ...
                "options": [
                  {"text": "A step-by-step procedure for solving a problem", "isCorrect": true},
              ...
              {
                "question": "What is the symbol for assignment operator in many programming languages?",
                "options": [
                  {"text": "=", "isCorrect": true},
              ...
              {
                "question": "Which operator is used to concatenate strings in many programming languages?",
                "options": [
                  {"text": "+", "isCorrect": true},
                  {"text": "*", "isCorrect": false},
                  {"text": "/", "isCorrect": false},
    ...
    return(
        <div className="maincontainer">
           <div className="box">
                {showScore ? (
                <div className="score">you scored {correct}over {questionList.length}
                <div>
                ...
                <>
                <h1>Question  {currentQuestion + 1} / {questionList.length}</h1>
